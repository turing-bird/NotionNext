...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ai.blog.xiaoniaoai.top', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.imesong.com/file/8e4c010b93fb1d03fab7b.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  WEB_WHIZ_CHAT_BOT_ID: process.env.NEXT_PUBLIC_WEB_WHIZ_CHAT_BOT_ID || GvrEU9_WD-JtL0aFlggHO, // 在后台获取ID
